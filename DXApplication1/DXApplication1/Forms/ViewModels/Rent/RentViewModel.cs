...
namespace DXApplication1.Forms.ViewModels {
    ...
    /// </summary>
    public partial class RentViewModel : SingleObjectViewModel<Rent, int, IRentCarContextUnitOfWork> {

        /// <summary>
        /// Creates a new instance of RentViewModel as a POCO view model.
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        public static RentViewModel Create(IUnitOfWorkFactory<IRentCarContextUnitOfWork> unitOfWorkFactory = null) {
        ...
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        protected RentViewModel(IUnitOfWorkFactory<IRentCarContextUnitOfWork> unitOfWorkFactory = null)
