...
namespace DXApplication1.Forms.ViewModels {
    ...
    /// </summary>
    public partial class FuelTypeCollectionViewModel : CollectionViewModel<FuelType, int, IRentCarContextUnitOfWork> {

        /// <summary>
        /// Creates a new instance of FuelTypeCollectionViewModel as a POCO view model.
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        public static FuelTypeCollectionViewModel Create(IUnitOfWorkFactory<IRentCarContextUnitOfWork> unitOfWorkFactory = null) {
        ...
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        protected FuelTypeCollectionViewModel(IUnitOfWorkFactory<IRentCarContextUnitOfWork> unitOfWorkFactory = null)
