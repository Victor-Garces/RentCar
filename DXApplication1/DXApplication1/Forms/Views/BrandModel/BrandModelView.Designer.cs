namespace DXApplication1.Forms.Views.BrandModelView {
    partial class BrandModelView {
		...
		private void InitializeComponent() {
			...
			this.brandModelViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.brandModelViewBindingSource.DataSource = typeof(DXApplication1.DataLayer.Models.BrandModel);
			this.dataLayoutControl1.DataSource = brandModelViewBindingSource;
			//
			//Create GridControls
			//
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters BrandVehiclesChildPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            BrandVehiclesChildPopulateColumnParameters.FieldName = "BrandVehicles";
            BrandVehiclesChildPopulateColumnParameters.Path = "Brand.Description";
			VehiclesPopulateColumnsParameters.CustomColumnParameters.Add(BrandVehiclesChildPopulateColumnParameters);
			...
			this.BrandLookUpEdit.DataBindings.Add("EditValue", brandModelViewBindingSource, "BrandId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(DXApplication1.Forms.ViewModels.BrandModelViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "BrandModel - Element View";
		...
		private System.Windows.Forms.BindingSource brandModelViewBindingSource;
