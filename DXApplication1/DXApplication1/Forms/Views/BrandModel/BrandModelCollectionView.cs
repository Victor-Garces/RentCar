...
namespace DXApplication1.Forms.Views.BrandModelCollectionView{
    public partial class BrandModelCollectionView : XtraUserControl {
        public BrandModelCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<DXApplication1.Forms.ViewModels.BrandModelCollectionViewModel>();
