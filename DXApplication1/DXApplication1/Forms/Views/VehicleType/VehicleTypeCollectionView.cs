...
namespace DXApplication1.Forms.Views.VehicleTypeCollectionView{
    public partial class VehicleTypeCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<DXApplication1.Forms.ViewModels.VehicleTypeCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as DXApplication1.DataLayer.Models.VehicleType,
