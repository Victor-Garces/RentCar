namespace DXApplication1.Forms.Views.BrandCollectionView {
    partial class BrandCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.brandCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.brandCollectionViewBindingSource.DataSource = typeof(DXApplication1.DataLayer.Models.Brand);
			this.gridControl.DataSource = brandCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters BrandModelsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            BrandModelsPopulateColumnParameters_NotVisible.FieldName = "BrandModels";
		    BrandModelsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(BrandModelsPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(DXApplication1.DataLayer.Models.Brand),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(DXApplication1.Forms.ViewModels.BrandCollectionViewModel);
			// 
            // layoutControl
            // 
		...
		private System.Windows.Forms.BindingSource brandCollectionViewBindingSource;
