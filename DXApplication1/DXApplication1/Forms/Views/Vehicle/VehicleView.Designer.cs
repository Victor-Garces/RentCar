    ...
    partial class VehicleView {
		...
		private void InitializeComponent() {
			...
			this.RentsPopUpMenu = new DevExpress.XtraBars.PopupMenu(this.components);
						...
						((System.ComponentModel.ISupportInitialize)(this.RentsBarManager)).BeginInit();
									this.BrandLookUpEdit = new DevExpress.XtraEditors.GridLookUpEdit();
			this.BrandBindingSource = new System.Windows.Forms.BindingSource(this.components);
						this.BrandModelLookUpEdit = new DevExpress.XtraEditors.GridLookUpEdit();
			...
			this.vehicleViewBindingSource.DataSource = typeof(DXApplication1.DataLayer.Models.Vehicle);
			this.dataLayoutControl1.DataSource = vehicleViewBindingSource;
			//
			//Create GridControls
			//
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters BrandInspectionsChildPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            BrandInspectionsChildPopulateColumnParameters.FieldName = "BrandInspections";
            BrandInspectionsChildPopulateColumnParameters.Path = "Brand.Description";
			InspectionsPopulateColumnsParameters.CustomColumnParameters.Add(BrandInspectionsChildPopulateColumnParameters);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters BrandModelInspectionsChildPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            BrandModelInspectionsChildPopulateColumnParameters.FieldName = "BrandModelInspections";
            BrandModelInspectionsChildPopulateColumnParameters.Path = "BrandModel.Description";
			InspectionsPopulateColumnsParameters.CustomColumnParameters.Add(BrandModelInspectionsChildPopulateColumnParameters);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters FuelTypeInspectionsChildPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            FuelTypeInspectionsChildPopulateColumnParameters.FieldName = "FuelTypeInspections";
            FuelTypeInspectionsChildPopulateColumnParameters.Path = "FuelType.Description";
			InspectionsPopulateColumnsParameters.CustomColumnParameters.Add(FuelTypeInspectionsChildPopulateColumnParameters);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters VehicleTypeInspectionsChildPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            VehicleTypeInspectionsChildPopulateColumnParameters.FieldName = "VehicleTypeInspections";
            VehicleTypeInspectionsChildPopulateColumnParameters.Path = "VehicleType.Description";
			InspectionsPopulateColumnsParameters.CustomColumnParameters.Add(VehicleTypeInspectionsChildPopulateColumnParameters);
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters BrandRentsChildPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            BrandRentsChildPopulateColumnParameters.FieldName = "BrandRents";
            BrandRentsChildPopulateColumnParameters.Path = "Brand.Description";
			RentsPopulateColumnsParameters.CustomColumnParameters.Add(BrandRentsChildPopulateColumnParameters);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters BrandModelRentsChildPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            BrandModelRentsChildPopulateColumnParameters.FieldName = "BrandModelRents";
            BrandModelRentsChildPopulateColumnParameters.Path = "BrandModel.Description";
			RentsPopulateColumnsParameters.CustomColumnParameters.Add(BrandModelRentsChildPopulateColumnParameters);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters FuelTypeRentsChildPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            FuelTypeRentsChildPopulateColumnParameters.FieldName = "FuelTypeRents";
            FuelTypeRentsChildPopulateColumnParameters.Path = "FuelType.Description";
			RentsPopulateColumnsParameters.CustomColumnParameters.Add(FuelTypeRentsChildPopulateColumnParameters);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters VehicleTypeRentsChildPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            VehicleTypeRentsChildPopulateColumnParameters.FieldName = "VehicleTypeRents";
            VehicleTypeRentsChildPopulateColumnParameters.Path = "VehicleType.Description";
			RentsPopulateColumnsParameters.CustomColumnParameters.Add(VehicleTypeRentsChildPopulateColumnParameters);
			...
			//BrandLookUpEdit
			//
			this.BrandBindingSource.DataSource = typeof(DXApplication1.DataLayer.Models.Brand);
			this.BrandLookUpEdit.Properties.ValueMember = "Id"; 
			this.BrandLookUpEdit.Properties.DisplayMember = "Description";
			this.BrandLookUpEdit.Properties.DataSource = this.BrandBindingSource;
			this.BrandLookUpEdit.Name = "BrandLookUpEdit";
			this.BrandLookUpEdit.DataBindings.Add("EditValue", vehicleViewBindingSource, "BrandId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			DevExpress.XtraDataLayout.RetrieveFieldParameters BrandLookUpEditRetrieveFieldParameters = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
            BrandLookUpEditRetrieveFieldParameters.FieldName = "BrandId";
            BrandLookUpEditRetrieveFieldParameters.ControlForField = this.BrandLookUpEdit;
			parameters.CustomListParameters.Add(BrandLookUpEditRetrieveFieldParameters);
			DevExpress.XtraDataLayout.RetrieveFieldParameters BrandLookUpEditRetrieveFieldParameters_NotGenerate = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
		    BrandLookUpEditRetrieveFieldParameters_NotGenerate.FieldName = "Brand";
		    BrandLookUpEditRetrieveFieldParameters_NotGenerate.GenerateField = false;
			parameters.CustomListParameters.Add(BrandLookUpEditRetrieveFieldParameters_NotGenerate);
						//
			//BrandModelLookUpEdit
			//
			this.BrandModelBindingSource.DataSource = typeof(DXApplication1.DataLayer.Models.BrandModel);
			this.BrandModelLookUpEdit.Properties.ValueMember = "Id"; 
			this.BrandModelLookUpEdit.Properties.DisplayMember = "Description";
			this.BrandModelLookUpEdit.Properties.DataSource = this.BrandModelBindingSource;
			this.BrandModelLookUpEdit.Name = "BrandModelLookUpEdit";
			this.BrandModelLookUpEdit.DataBindings.Add("EditValue", vehicleViewBindingSource, "BrandModelId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			DevExpress.XtraDataLayout.RetrieveFieldParameters BrandModelLookUpEditRetrieveFieldParameters = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
            BrandModelLookUpEditRetrieveFieldParameters.FieldName = "BrandModelId";
            BrandModelLookUpEditRetrieveFieldParameters.ControlForField = this.BrandModelLookUpEdit;
			parameters.CustomListParameters.Add(BrandModelLookUpEditRetrieveFieldParameters);
			DevExpress.XtraDataLayout.RetrieveFieldParameters BrandModelLookUpEditRetrieveFieldParameters_NotGenerate = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
		    BrandModelLookUpEditRetrieveFieldParameters_NotGenerate.FieldName = "BrandModel";
		    BrandModelLookUpEditRetrieveFieldParameters_NotGenerate.GenerateField = false;
			parameters.CustomListParameters.Add(BrandModelLookUpEditRetrieveFieldParameters_NotGenerate);
						//
			//FuelTypeLookUpEdit
			//
			this.FuelTypeBindingSource.DataSource = typeof(DXApplication1.DataLayer.Models.FuelType);
			...
			this.FuelTypeLookUpEdit.DataBindings.Add("EditValue", vehicleViewBindingSource, "FuelTypeId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			DevExpress.XtraDataLayout.RetrieveFieldParameters FuelTypeLookUpEditRetrieveFieldParameters = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
            FuelTypeLookUpEditRetrieveFieldParameters.FieldName = "FuelTypeId";
            FuelTypeLookUpEditRetrieveFieldParameters.ControlForField = this.FuelTypeLookUpEdit;
			parameters.CustomListParameters.Add(FuelTypeLookUpEditRetrieveFieldParameters);
			DevExpress.XtraDataLayout.RetrieveFieldParameters FuelTypeLookUpEditRetrieveFieldParameters_NotGenerate = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
		    FuelTypeLookUpEditRetrieveFieldParameters_NotGenerate.FieldName = "FuelType";
		    FuelTypeLookUpEditRetrieveFieldParameters_NotGenerate.GenerateField = false;
			parameters.CustomListParameters.Add(FuelTypeLookUpEditRetrieveFieldParameters_NotGenerate);
						//
			//VehicleTypeLookUpEdit
			//
			this.VehicleTypeBindingSource.DataSource = typeof(DXApplication1.DataLayer.Models.VehicleType);
			...
			this.VehicleTypeLookUpEdit.DataBindings.Add("EditValue", vehicleViewBindingSource, "VehicleTypeId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			DevExpress.XtraDataLayout.RetrieveFieldParameters VehicleTypeLookUpEditRetrieveFieldParameters = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
            VehicleTypeLookUpEditRetrieveFieldParameters.FieldName = "VehicleTypeId";
            VehicleTypeLookUpEditRetrieveFieldParameters.ControlForField = this.VehicleTypeLookUpEdit;
			parameters.CustomListParameters.Add(VehicleTypeLookUpEditRetrieveFieldParameters);
			DevExpress.XtraDataLayout.RetrieveFieldParameters VehicleTypeLookUpEditRetrieveFieldParameters_NotGenerate = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
		    VehicleTypeLookUpEditRetrieveFieldParameters_NotGenerate.FieldName = "VehicleType";
		    VehicleTypeLookUpEditRetrieveFieldParameters_NotGenerate.GenerateField = false;
			parameters.CustomListParameters.Add(VehicleTypeLookUpEditRetrieveFieldParameters_NotGenerate);
            ...
            this.mvvmContext.ViewModelType = typeof(DXApplication1.Forms.ViewModels.VehicleViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "Vehicle - Element View";
		...
		private DevExpress.XtraBars.PopupMenu RentsPopUpMenu;
				...
				private DevExpress.XtraBars.BarButtonItem bbiRentsRefresh;
								private DevExpress.XtraEditors.GridLookUpEdit BrandLookUpEdit;
		private System.Windows.Forms.BindingSource BrandBindingSource;
				private DevExpress.XtraEditors.GridLookUpEdit BrandModelLookUpEdit;
