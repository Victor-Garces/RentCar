namespace DXApplication1.Forms.Views.RentView {
    partial class RentView {
		...
		private void InitializeComponent() {
			...
			this.rentViewBindingSource.DataSource = typeof(DXApplication1.DataLayer.Models.Rent);
			...
			//ClientLookUpEdit
			//
			this.ClientBindingSource.DataSource = typeof(DXApplication1.DataLayer.Models.Client);
			...
			//EmployeeLookUpEdit
			//
			this.EmployeeBindingSource.DataSource = typeof(DXApplication1.DataLayer.Models.Employee);
			...
			//VehicleLookUpEdit
			//
			this.VehicleBindingSource.DataSource = typeof(DXApplication1.DataLayer.Models.Vehicle);
            ...
            this.mvvmContext.ViewModelType = typeof(DXApplication1.Forms.ViewModels.RentViewModel);
			// 
            // labelControl
            // 
