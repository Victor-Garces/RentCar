namespace DXApplication1.Forms.Views.UserCollectionView {
    partial class UserCollectionView {
		...
		private void InitializeComponent() {
			...
			this.userCollectionViewBindingSource.DataSource = typeof(DXApplication1.DataLayer.Models.User);
			...
			this.gridView.PopulateColumns(typeof(DXApplication1.DataLayer.Models.User),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(DXApplication1.Forms.ViewModels.UserCollectionViewModel);
			// 
            // layoutControl
            // 
